...
function Register() {
  ...
  return (
    <motion.div
      ...
      className="flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-100 to-gray-900 p-6"
    >
      <div className="flex flex-col md:flex-row bg-white shadow-lg rounded-xl overflow-hidden max-w-5xl w-full">
        {/* Left side: Form */}
